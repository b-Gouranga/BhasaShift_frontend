  ...
  return (
    <div className="flex flex-col min-h-screen bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-950 dark:to-blue-950 text-foreground font-sans">
      ...
      <section className="flex-1 flex flex-col items-center justify-center px-4 py-16 sm:py-24 gap-8 text-center">
        <h1 className="text-4xl sm:text-5xl font-bold tracking-tight mb-4 text-blue-700 dark:text-blue-400">
          Empower Assamese Creativity
        </h1>
        <p className="text-lg sm:text-xl max-w-2xl mx-auto mb-8 text-muted-foreground">
          Instantly translate Assamese to English and generate stunning images from Assamese prompts. Break language barriers and unleash your imagination.
        </p>
        <div className="flex justify-center">
          <div className="flex flex-col sm:flex-row gap-4 p-6 rounded-xl w-fit">
            <Link
              href="/dashboard/translation"
              className="group inline-flex items-center justify-center rounded-full bg-gradient-to-r from-white via-blue-100 to-blue-300 text-gray-900 px-6 py-3 font-medium text-lg shadow-lg transition hover:from-blue-50 hover:via-blue-200 hover:to-blue-400 hover:scale-105 focus-visible:outline focus-visible:ring-2 focus-visible:ring-blue-400 border-2 border-transparent hover:border-blue-400 duration-200"
            >
      ...
      {/* Features Section */}
      <section id="features" className="py-16 px-4 bg-gradient-to-br from-gray-50 via-white to-blue-50 dark:from-gray-900 dark:via-gray-950 dark:to-blue-950">
        <style>{`
          .flip-card {
            perspective: 1200px;
          }
              ...
              <div className="flip-card-inner">
                <div className="flip-card-front border-blue-300 dark:border-blue-800 bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-blue-950 dark:via-gray-950 dark:to-blue-900">
                  <div className="flex flex-col items-center w-full">
                    ...
                    <h3 className="font-bold text-xl mb-1">Seamless Translation</h3>
                  </div>
                </div>
              ...
              <div className="flip-card-inner">
                <div className="flip-card-front border-blue-300 dark:border-blue-800 bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-blue-950 dark:via-gray-950 dark:to-blue-900">
                  <div className="flex flex-col items-center w-full">
                    ...
                    <div className="w-12 h-1 bg-blue-200 dark:bg-blue-800 rounded-full mb-3" />
                    <h3 className="font-bold text-xl mb-1">AI Image Generation</h3>
                  </div>
                </div>
                <div className="flip-card-back border-blue-300 dark:border-blue-800 bg-background flex flex-col items-center justify-center">
              ...
              <div className="flip-card-inner">
                <div className="flip-card-front border-blue-300 dark:border-blue-800 bg-gradient-to-br from-blue-50 via-white to-blue-100 dark:from-blue-950 dark:via-gray-950 dark:to-blue-900">
                  <div className="flex flex-col items-center w-full">
                    ...
                    <div className="w-12 h-1 bg-blue-200 dark:bg-blue-800 rounded-full mb-3" />
                    <h3 className="font-bold text-xl mb-1">Fast & Responsive</h3>
                  </div>
                </div>
                <div className="flip-card-back border-blue-300 dark:border-blue-800 bg-background flex flex-col items-center justify-center">
